      ...
      <>
        <div className="footer_container">
          <div className="footer_logo_container">
            <img
              class="img-logo loaded"
              width="150"
              data-src="https://cdn.shopify.com/s/files/1/0609/1934/9479/files/icon-logo-footer.svg?v=1645615847"
              alt="Logo for EvenGreener"
              data-lazy-load=""
              loading="lazy"
          ...
          <div className="footer_quick_links_container">
            <div className="shop_links_container">
              <h4>SHOP</h4>
              <p>Bestsellers</p>
              <p>Composters</p>
              <p>Water Butts</p>
            </div>
            <div className="gtk_links_container">
              <h4>GOOD TO KNOW</h4>
              <p>About Us</p>
              <p>Bulk Enquiries</p>
              <p>Customer Reviews</p>
            </div>
            <div className="connect_links_container">
              <h4>CONNECT</h4>
              <p>Facebook</p>
              <p>Instagram</p>
              <p>YouTube</p>
            ...
            <div className="policis_links_container">
              <h4>POLICIES</h4>
              <p>T&Cs</p>
              <p>Cookie Policy</p>
              <p>Privacy Policy</p>
            </div>
            <div className="support_links_container">
              <h4>SUPPORT</h4>
              <p>Contact Us</p>
              <p>Help Centre</p>
            ...
            <div className="git_links_container">
              <h4>GET IN TOUCH</h4>
              <p>Email</p>
          ...
          <div className="copyright_container">
            <p>© 2025 EvenGreener. All Rights Reserved By Mihir Patel.</p>
